      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <span style={{
            ...
            fontSize: "0.7rem", color: isOpen ? "#60a5fa" : "var(--text-3)",
          ...
          <span style={{
            ...
            fontSize: "0.975rem", letterSpacing: "-0.01em",
      ...
      <div style={{
        ...
        <div ref={bodyRef} style={{ padding: "0 24px 24px 64px" }}>
          <p style={{
            ...
            fontSize: "0.9rem", color: "var(--text-2)", lineHeight: 1.75,
...
export default function FAQ() {
  ...
  useEffect(() => {
    const h = headerRef.current, l = listRef.current;
    if (!h || !l) return;
    const io1 = new IntersectionObserver(([e]) => { if (e.isIntersecting) { setHv(true); io1.disconnect(); } }, { threshold: 0.1 });
    const io2 = new IntersectionObserver(([e]) => { if (e.isIntersecting) { setLv(true); io2.disconnect(); } }, { threshold: 0.05 });
    io1.observe(h); io2.observe(l);
    ...
    <section style={{ padding: "120px 0", position: "relative", background: "var(--black)" }}>
      ...
      <div className="max-w-4xl mx-auto px-6" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div ref={listRef} style={{
          ...
          opacity: lv ? 1 : 0, transform: lv ? "none" : "translateY(24px)",
        }}>
          {FAQS.map((faq, i) => (
            <FAQItem
        ...
        {/* CTA */}
        <div style={{
          padding: "44px 40px", borderRadius: 20, textAlign: "center",
          ...
          <p style={{
            ...
            We're happy to discuss your specific requirements and answer anything.
          </p>
