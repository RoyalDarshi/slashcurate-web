...
const SERVICES = [
  {
    ...
    title: "BI & Analytics",
    description:
      "Custom dashboards, reporting systems, and real-time analytics that turn raw data into confident decisions.",
  ...
  },
  {
    ...
    description:
      "Production-grade ML pipelines, predictive models, and intelligent automation built to run at scale.",
  ...
  },
  {
    ...
    description:
      "Scalable data pipelines, warehouses, and ETL systems engineered for enterprise throughput.",
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered
          ? `0 24px 56px rgba(0,0,0,0.5), 0 0 0 1px ${s.color}20`
          : "none",
        cursor: "default",
        position: "relative",
        overflow: "hidden",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            From raw infrastructure to intelligent applications — designed to
